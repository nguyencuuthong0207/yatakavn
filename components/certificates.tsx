    ...
    <section className="py-8 md:py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="flex flex-col gap-6 md:gap-8">
          {/* Text Section - Top (mobile) */}
          <div className="text-center md:text-left max-w-2xl mx-auto md:mx-0 md:hidden">
          ...
          {/* Image Section with overlay text on desktop */}
              ...
              <div className="h-full w-full flex items-start">
                <div className="max-w-2xl m-8">
                  ...
                  <p className="text-gray-700 text-base lg:text-lg leading-relaxed">
                    Sản phẩm YATAKA được sản xuất theo quy trình nghiêm ngặt, đảm bảo chất lượng vượt trội và an toàn tuyệt đối
                    với các chứng nhận quốc tế như CE, ROHS và chứng nhận sản xuất thiết bị y tế Nhật Bản. Chúng tôi cam kết mang
                    đến những sản phẩm chất lượng cao nhất và sự yên tâm tuyệt đối cho khách hàng trên toàn thế giới.
                  </p>
                </div>
              </div>
            </div>
